<?php
require_once 'NonFictionController.php';
?>
<!DOCTYPE html>
<html>
<head>
...
<body>
   <div class="bs-example">
        ...
        <div class="row" >
            <div class="col-sm">
                ...
                if($_SESSION['username']=="admin")
                {
                    ...
                    <form method="POST" class="form-inline" style="margin-bottom: 3px" action="NonFictionController.php">
                ...
                <form method="POST" style="margin-bottom: 3px" class="form-inline" action="NonFictionController.php">
    ...
    <div id="id01" class="modal">
        <form class="modal-content"  tabindex="-1" role="dialog" action="NonFictionController.php" method="POST" enctype="multipart/form-data">
